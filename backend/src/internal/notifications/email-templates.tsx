  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>
          We have received your deposit request and proof of payment. Thank you for choosing our
        ...
        <Text>
          Our team will validate your deposit shortly. Once approved, we will issue your tokens at a
          1:1 ratio with your deposit amount.
        </Text>
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>Dear {userName},</Text>
        <Text>
          Great news! Your deposit has been approved and tokens have been programed to be issued:
        </Text>
        <Text>
          <strong>Amount Deposited:</strong> ${amount}
        </Text>
        <Text>
          <strong>Tokens Issued:</strong> {amount} (1:1 ratio)
        </Text>
        <Text>
          <strong>Deposit ID:</strong> {depositId}
        </Text>
        <Text>
          Thank you for choosing our tokenization service. Your tokens will show be available in
          your wallet shortly.
        </Text>
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>
          If you have any questions or need further clarification about the tokenization process,
          please don't hesitate to contact our support team. We're here to help you with your
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>
          <strong>Amount Minted:</strong> {amount} tokens
        </Text>
        <Text>
          <strong>Deposit ID:</strong> {depositId}
        </Text>
        ...
        <Text>
          Your tokens are now available in your wallet. You can use them for various purposes within
          our ecosystem.
        </Text>
        <Text>
          If you have any questions about your minted tokens or how to use them, please don't
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>
          <strong>Redeem Request ID:</strong> {burnRequestId}
        </Text>
        <Text>
          Our team will process your redeem request shortly. Once approved, we will initiate the
          token burning process and transfer the corresponding funds to your specified account.
        </Text>
        <Text>We'll notify you as soon as the validation process is complete.</Text>
      </Container>
    </Body>
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>Dear {userName},</Text>
        <Text>
          Great news! Your burn request has been approved and the tokens have been burned:
        </Text>
        <Text>
          <strong>Amount Burned:</strong> {amount} tokens
        </Text>
        <Text>
          <strong>Burn Request ID:</strong> {burnRequestId}
        </Text>
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>
          If you have any questions or need further clarification about the token burning process,
          please don't hesitate to contact our support team. We're here to help you with your burn
          request.
        </Text>
  ...
  <Html>
    ...
    <Body style={baseStyles}>
      <Container style={containerStyles}>
        ...
        <Text>Dear {userName},</Text>
        <Text>
          We are pleased to inform you that your redeem request has been completed successfully:
        </Text>
        <Text>
          <strong>Amount Redeemed:</strong> {amount} tokens
        </Text>
        <Text>
          <strong>Redeem Request ID:</strong> {burnRequestId}
        </Text>
        <Text>
          The corresponding funds have been transferred to your specified account. You can view the
          proof of transfer below:
        </Text>
        <Img src={proofImageUrl} alt="Proof of Transfer" width="100%" />
        <Text>
          Thank you for using our token burning service. If you have any questions or concerns,
