...
import "./ROFL_Oracle.sol";

/**
 * @dev Contract deployed on Sapphire Testnet
 * @notice You can view the deployed contract at:
 * https://explorer.oasis.io/testnet/sapphire/address/0xd28eb2D29964127D102cD0047A1fee319B328Bca
*/
...
contract CLPD is ERC20, Ownable {
    ...
    constructor() ERC20(_tokenName, _tokenSymbol) Ownable(msg.sender) {
        _tokenName = "CLPD";
        _tokenSymbol = "CLPD";
        vaultOracle = VaultOracle(0xEdDa5130fD503445AB7c4520DA7ef1b55Be0372A);
    }
    ...
    function verifyValueAPI() public onlyAgent {
        (uint256 totalSupplyAllChains, uint256 currentBankBalance) = vaultOracle.getVaultData();
    ...
    function bridgeCLPD(uint256 amount) public {
