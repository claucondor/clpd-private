  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "flex size-8 flex-1 items-center justify-center rounded-md p-0 text-sm [&:has(button)]:hover:!bg-black/10 [&:has(button)]:hover:text-black/10-foreground [&:has(button)]:hover:aria-selected:!bg-primary [&:has(button)]:hover:aria-selected:text-primary-foreground",
        day_button: cn(
        ...
        today: "bg-black/10 text-black/10",
        outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-black/10 aria-selected:text-muted-foreground aria-selected:opacity-30",
        disabled: "text-muted-foreground opacity-50",
        range_middle:
          "rounded-none aria-selected:bg-black/10 aria-selected:text-black/10 hover:aria-selected:!bg-black/10 hover:aria-selected:text-black/10-foreground",
